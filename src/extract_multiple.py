"""
Extracts the features for multiple different numbers and/or fractions of sessions.
"""
...
@hydra.main(version_base="1.3", config_path="../config", config_name="extract_multiple")
